# slack-gitlab-notification-bot

This is a sample template for slack-gitlab-notification-bot - Below is a brief explanation of what we have generated for you:

```bash
.
├── Makefile                    <-- Make to automate build
├── README.md                   <-- This instructions file
├── notify                 <-- Source code for a lambda function
